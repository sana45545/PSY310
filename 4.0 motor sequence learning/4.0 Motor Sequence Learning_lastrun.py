...
expName = '4.0 Motor Sequence Learning'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91635\\Desktop\\Lab In Psych\\4.0 motor sequence learning\\4.0 Motor Sequence Learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial_2 in trials_2:
        ...
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        routine_2Components = [Fixation, Line1, Line2, Line3, Line4, Probe, key_resp_2]
