...
expName = '5.0 Word Priming'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91635\\Desktop\\Lab In Psych\\5.0 Word Priming\\5.0 Word Priming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if StudyText.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            ...
            if Studyslider.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
    ...
    for thisTrial_2 in trials_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('Routine_2.started', globalClock.getTime(format='float'))
        ...
        # keep track of which components have finished
        Routine_2Components = [text_2, textbox, text_3, mouse]
        ...
        for thisComponent in Routine_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('Routine_2.stopped', globalClock.getTime(format='float'))
